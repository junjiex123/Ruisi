    ...
    public void startTickAnim () {
        ...
        Animation tickAnim = new Animation() {
            ...
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                if (0.54 < interpolatedTime && 0.7 >= interpolatedTime) {  // grow chat_bg_left and chat_bg_right rect to chat_bg_right
                    ...
                    invalidate();
                } else if (0.7 < interpolatedTime && 0.84 >= interpolatedTime) { // shorten chat_bg_left rect from chat_bg_right, still grow chat_bg_right rect
                    mLeftRectGrowMode = false;
                    ...
                    mRightRectWidth = MAX_RIGHT_RECT_W * ((interpolatedTime - 0.65f) / 0.19f);
                    invalidate();
                } else if (0.84 < interpolatedTime && 1 >= interpolatedTime) { // restore chat_bg_left rect width, shorten chat_bg_right rect to const
                    mLeftRectGrowMode = false;
